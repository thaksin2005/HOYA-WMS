...
const LogMoldProcessRoutes = require('./routes/LogMoldProcess');
const LogMoldBlockRoutes = require('./routes/LogMoldBlock');
//IF
...
app.use('/api', LogMoldProcessRoutes);
app.use('/api', LogMoldBlockRoutes);
// 404 Error Handler
