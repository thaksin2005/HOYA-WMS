...
import { Drawer, Form, Input, Button, Space, Row, Col, notification } from "antd";
      ...
      {open ? (
        <>
          <Form form={form} layout="vertical">
            ...
            <Row gutter={24}>
              <Col span={4}>
                <Form.Item label="Job Number" name="ORI_JobNumber" rules={[{ required: true, message: "Please enter Job Number" }]}>
                  <Input placeholder="Enter Job Number" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Mold Master ID Upper" name="MS_IDUpperMold" rules={[{ required: true, message: "Please enter Mold Master ID Upper Mold" }]}>
                  <Input placeholder="Enter Upper Mold" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Mold Master ID Lower" name="MS_IDLowerMold" rules={[{ required: true, message: "Please enter Mold Master ID Lower" }]}>
                  <Input placeholder="Enter Lower Mold" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Status" name="ORI_Status" rules={[{ required: true, message: "Please enter Status" }]}>
                  <Input placeholder="Enter Status" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label=" Production Order" name="ORI_ProductionOrder" rules={[{ required: true, message: "Please enter Production Order" }]}>
                  <Input placeholder="Enter Production Order" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="ORI Order Date" name="ORI_OrderDate" rules={[{ required: true, message: "Please enter Order Date" }]}>
            ...
            <Row gutter={24}>
              <Col span={4}>
                <Form.Item label="Input Date" name="ORI_InputDate" rules={[{ required: true, message: "Please enter Input Date" }]}>
              ...
              <Col span={4}>
                <Form.Item label="Stie" name="ORI_Stie" rules={[{ required: true, message: "Please enter Stie" }]}>
                  <Input placeholder="Enter Stie" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Production Type" name="ORI_ProductionType" rules={[{ required: true, message: "Please enter Production Type" }]}>
                  <Input placeholder="Enter Production Type" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Production No" name="ORI_ProductionNo" rules={[{ required: true, message: "Please enter Production No" }]}>
                  <Input placeholder="Enter ORI Production No" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Request Date" name="ORI_RequestDate" rules={[{ required: true, message: "Please enter Request Date" }]}>
            ...
            <Row gutter={24}>
              ...
              <Col span={4}>
                <Form.Item label="Edge" name="ORI_Edge" rules={[{ required: true, message: "Please enter Edge" }]}>
                  <Input placeholder="Enter Edge" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Lot Msg" name="ORI_LotMsg" rules={[{ required: true, message: "Please enter Lot Msg" }]}>
                  <Input placeholder="Enter Lot Msg" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Lot Type" name="ORI_LotType" rules={[{ required: true, message: "Please enter Lot Type" }]}>
            ...
            <Row gutter={24}>
              ...
              <Col span={4}>
                <Form.Item label="Product DIA" name="ORI_ProductDIA" rules={[{ required: true, message: "Please enter Product DIA" }]}>
                  <Input placeholder="Enter Product DIA" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="End Item Name" name="ORI_EndItemName" rules={[{ required: true, message: "Please enter End Item Name" }]}>
                  <Input placeholder="Enter End Item Name" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Mold Upper" name="ORI_MoldUpper" rules={[{ required: true, message: "Please enter Mold Upper" }]}>
            ...
            <Row gutter={24}>
              ...
              <Col span={4}>
                <Form.Item label="Mold Lower Name" name="ORI_MoldLowerName" rules={[{ required: true, message: "Please enter Mold Lower Name" }]}>
                  <Input placeholder="Enter Mold Lower Name" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Mold Lower DIA" name="ORI_MoldLowerDIA" rules={[{ required: true, message: "Please enter Mold Lower DIA" }]}>
                  <Input placeholder="Enter Mold Lower DIA" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Cast Oven No" name="ORI_CastOvenNo" rules={[{ required: true, message: "Please enter Cast Oven No" }]}>
              ...
              <Col span={4}>
                <Form.Item label="Oven Time" name="ORI_OvenMMTime" rules={[{ required: true, message: "Please enter Oven Time" }]}>
            ...
            <Row gutter={24}>
              ...
              <Col span={4}>
                <Form.Item label="Mold Place" name="ORI_MoldPlace" rules={[{ required: true, message: "Please enter Mold Place" }]}>
                  <Input placeholder="Enter Mold Place" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Warehouse" name="ORI_Warehouse" rules={[{ required: true, message: "Please enter Warehouse" }]}>
                  <Input placeholder="Enter Warehouse" />
                </Form.Item>
              </Col>
              <Col span={4}>
                <Form.Item label="Instruction" name="ORI_Instruction" rules={[{ required: true, message: "Please enter Instruction" }]}>
